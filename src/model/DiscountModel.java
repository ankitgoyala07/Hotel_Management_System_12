...
/**
 * Model class representing a Discount/Deal record.
 */
public class DiscountModel {
    ...
    public int getReservationsLeft() { return reservationsLeft; }
    public void setReservationsLeft(int reservationsLeft) { this.reservationsLeft = reservationsLeft; }
