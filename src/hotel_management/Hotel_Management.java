...
public class Hotel_Management {
    ...
    public static void main(String[] args) {
        if (args.length > 0 && (args[0].equals("-d") || args[0].equals("--diagnose"))) {
            runDiagnostics(args);
            return;
        }
    ...
    public static void runDiagnostics(String[] args) {
        ...
        try {
            var resource = Hotel_Management.class.getResource("/images/hotelpic.png");
            if (resource != null) {
